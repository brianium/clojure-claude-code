...
A full-stack Clojure/ClojureScript project with Claude Code integration.
...
### Start ClojureScript Development

```bash
clj -M:dev:fig:cljs-build
```

This starts Figwheel-main which will compile ClojureScript, start a development server at http://localhost:9500, and hot-reload on changes.
...
clj-nrepl-eval -p <PORT> "(<<main>>/some-function)"
```

## Project Structure

```
src/clj/<<top/file>>/      # Clojure backend source files
src/cljc/<<top/file>>/     # Shared Clojure/ClojureScript code
src/cljs/<<top/file>>/     # ClojureScript frontend source files
dev/src/clj/               # Development namespace (user.clj, dev.clj)
test/src/clj/<<top/file>>/ # Test files
resources/                 # Resource files
resources/public/          # Static assets (CSS, images, etc.)
```
